...
<body>
    ...
    <!-- make login and sigj up show only home button on index page  -->
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="images/farm2.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                                    <h1 class="display-2 mb-5 animated slideInDown">Best Place for Farming Tools and Materials</h1>
                                    <?php
                                
                                    if(!isset($_SESSION['cid'])){
                                     ?>
                                    <a href="login/loginform.php"
                                        class="btn btn-primary rounded-pill py-sm-3 px-sm-5">Login</a>
                                    <a href="login/registerform.php"
                                        class="btn btn-secondary rounded-pill py-sm-3 px-sm-5 ms-3">Signup</a>
                                    <?php
                                    } 
                                    ?>
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="about-img position-relative overflow-hidden p-5 pe-0">
                        <img class="img-fluid w-100" src="images/farm1.jpg">
                    </div>
                </div>
