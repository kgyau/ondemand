...
<body>
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container">
            <h1 class="display-3 mb-3 animated slideInDown">Search results</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a class="text-body" href="index.php">Home</a></li>
                    <li class="breadcrumb-item text-dark active" aria-current="page">Search results</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div id="tab-1" class="tab-pane fade show p-0 active">
            <div class="row g-4">
                <?php
                                ...
                                <img class='img-fluid w-100' src= '../products/".$product_image."'  style='height: 300px ; ' >
                                ...
                                <small class='w-50 text-center py-2'>
                                    <a class='text-body'href='../actions/add_to_cart.php?product_id={$aproduct['product_id']}'><i class='fa fa-shopping-bag text-primary me-2' name='addtocart'></i>Add to cart</a>
                                </small>
