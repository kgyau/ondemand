            ...
            <div class="row g-0 gx-5 align-items-end">
                <div class="col-lg-6">
                    <div class="section-header text-start mb-5 wow fadeInUp" data-wow-delay="0.1s"
                        ...
                        <h1 class="display-5 mb-3">Our Products for Rent</h1>
                        <p>Farmers materials</p>
                    </div>
                </div>
                <div class="col-lg-6 text-start text-lg-end wow slideInRight" data-wow-delay="0.1s">
                    <ul class="nav nav-pills d-inline-flex justify-content-end mb-5">
                        <li class="nav-item me-1">
                            <a class="btn btn-outline-primary border-2"  href="../view/product.php">Fishermen</a>
                        </li>
                        <li class="nav-item me-2">
                            <a class="btn btn-outline-primary border-2 active" href="../view/product_rentals.php">Rentals</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="row g-4">
                            ...
                            <?php
                                ...
                                <small class='w-50 text-center border-end py-2'>
                                    <a class='text-body' href='../view/single_product.php?product_id={$aproduct['product_id']}'><i class='fa fa-eye text-primary me-2'></i>View detail</a>
                                </small>
                                <small class='w-50 text-center py-2'>
                                    <a class='text-body'href='../actions/add_to_cart.php?product_id={$aproduct['product_id']}'><i class='fa fa-shopping-bag text-primary me-2'></i>Add to cart</a>
                                </small>
